  ...
  return (
    <main className="min-h-screen bg-luxury-black text-luxury-white font-sans selection:bg-luxury-gold selection:text-black">
      ...
      <nav className="fixed w-full z-50 top-4 flex justify-center px-4 md:px-6">
        <div className="w-full max-w-6xl bg-luxury-black/70 backdrop-blur-xl border border-luxury-gold/20 rounded-full shadow-[0_10px_40px_rgba(0,0,0,0.8)] px-5 md:px-8 h-[64px] md:h-[70px] flex items-center justify-between transition-all duration-300 hover:border-luxury-gold/40">
          ...
          <div className="hidden lg:flex flex-1 justify-center space-x-8">
            <a href="#inicio" className="text-[13px] tracking-[0.18em] font-semibold text-luxury-white hover:text-luxury-gold transition-colors uppercase relative group">
              Inicio
              <span className="absolute -bottom-2 left-1/2 w-0 h-[2px] bg-luxury-gold transition-all duration-300 group-hover:w-[14px] group-hover:left-[calc(50%-7px)]"></span>
            </a>

            <a href="#servicios" className="text-[13px] tracking-[0.18em] font-medium text-luxury-white hover:text-luxury-gold transition-colors uppercase relative group">
              Servicios
              <span className="absolute -bottom-2 left-1/2 w-0 h-[2px] bg-luxury-gold transition-all duration-300 group-hover:w-[14px] group-hover:left-[calc(50%-7px)]"></span>
            </a>

            <a href="#flota" className="text-[13px] tracking-[0.18em] font-medium text-luxury-white hover:text-luxury-gold transition-colors uppercase relative group">
              Flota
              <span className="absolute -bottom-2 left-1/2 w-0 h-[2px] bg-luxury-gold transition-all duration-300 group-hover:w-[14px] group-hover:left-[calc(50%-7px)]"></span>
            </a>

            <a href="#contacto" className="text-[13px] tracking-[0.18em] font-medium text-luxury-white hover:text-luxury-gold transition-colors uppercase relative group">
              Contacto
              <span className="absolute -bottom-2 left-1/2 w-0 h-[2px] bg-luxury-gold transition-all duration-300 group-hover:w-[14px] group-hover:left-[calc(50%-7px)]"></span>
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-6">
            <a href="/en" className="text-[12px] tracking-[0.18em] font-semibold text-luxury-white hover:text-luxury-gold transition-all duration-300 uppercase border border-luxury-gold/30 hover:border-luxury-gold/80 rounded-full px-3 py-1 flex items-center justify-center">
              EN
            </a>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-20">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left z-20 relative px-4 lg:pr-12 mb-0 lg:mb-0 mt-8 lg:mt-0">
            <h1 className="font-display uppercase tracking-[0.05em] mb-10 lg:w-[125%] xl:w-[135%]">
              <span className="block text-4xl md:text-5xl lg:text-[3.5rem] leading-[1.1] mb-5">
                <span className="block text-[#F1F1F1] font-light opacity-90 drop-shadow-sm tracking-normal mb-1">
                  La excelencia en el transporte de lujo,
                </span>
            ...
            <div className="max-w-2xl lg:max-w-3xl xl:max-w-[120%] mx-auto lg:mx-0 space-y-6 mb-12 text-left relative z-20">
              <p className="text-[18px] md:text-[20px] text-luxury-gray font-light leading-[1.8em] border-l-2 border-luxury-gold/50 pl-5">
                Flotilla de última generación con unidades blindadas y no blindadas, operadas por choferes altamente capacitados para garantizar comodidad, discreción y una experiencia impecable en cada trayecto.
              </p>

              <p className="text-[16px] md:text-[18px] tracking-[0.05em] text-luxury-gray font-light leading-[1.6em] pl-5">
                Eventos especiales, traslados ejecutivos, viajes vacacionales y recorridos exclusivos con atención personalizada y protocolos profesionales.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start mb-14">
              <a href="https://wa.me/526623538274?text=Hola,%20me%20interesa%20informaci%C3%B3n%20sobre%20sus%20servicios." target="_blank" rel="noopener noreferrer" className="inline-block text-center bg-gradient-to-r from-luxury-gold to-[#a88231] hover:from-luxury-gold-soft hover:to-luxury-gold text-black px-10 py-4 uppercase tracking-[0.2em] text-[11px] font-bold transition-all duration-300 shadow-[0_4px_20px_rgba(204,167,80,0.3)] rounded-sm">
                Cotizar Ahora
              </a>
              <a href="https://wa.me/526623538274?text=Hola,%20deseo%20programar%20una%20llamada." target="_blank" rel="noopener noreferrer" className="inline-block text-center border border-luxury-gold/50 hover:border-luxury-gold hover:bg-luxury-gold/10 text-luxury-white px-10 py-4 uppercase tracking-[0.2em] text-[11px] font-bold transition-all duration-300 backdrop-blur-sm rounded-sm relative z-20 overflow-hidden">
                Contactar
              </a>
            </div>
            ...
            <div className="text-center w-full max-w-xl mx-auto lg:mx-0">
              <p className="text-[14px] md:text-[15px] tracking-[0.25em] uppercase text-luxury-gold font-medium">
                Tu comodidad y seguridad, nuestro compromiso.
              </p>
            </div>
          </div>
        ...
        <section id="quienes-somos" className="py-24 border-t border-luxury-gray/10 relative">
          <div className="bg-[#151515] border border-luxury-gray/20 rounded-2xl p-8 md:p-12 lg:p-16 shadow-[0_10px_40px_rgba(0,0,0,0.5)] backdrop-blur-sm relative overflow-hidden">
            {/* Ambient Background for Container */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-luxury-gold/5 blur-[80px] rounded-full pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-luxury-gold/5 blur-[80px] rounded-full pointer-events-none"></div>

            <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center relative z-10">
              {/* Image Left */}
              <div className="w-full lg:w-5/12 relative">
                <div className="absolute inset-0 bg-luxury-gold/10 blur-2xl rounded-lg -z-10 translate-x-2 translate-y-2"></div>
                <div className="relative aspect-[4/5] lg:aspect-[4/5] w-full rounded-xl overflow-hidden shadow-[0_15px_30px_rgba(0,0,0,0.6)] group">
                  <Image
                    src="/quienes-somos-vertical.jpg"
                    alt="Luxury VIP Protection - Quiénes Somos"
                    fill
              ...
              <div className="w-full lg:w-7/12 flex flex-col justify-center space-y-6">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <span className="text-[10px] text-luxury-gold uppercase tracking-[0.3em] font-semibold">SOBRE NOSOTROS</span>
                </div>

                <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-display font-light uppercase leading-tight mb-2">
                  QUIÉNES <span className="font-bold text-luxury-gold drop-shadow-[0_0_10px_rgba(204,167,80,0.3)]">SOMOS</span>
                </h2>

                <div className="space-y-5 text-[16px] md:text-[17px] text-luxury-gray font-light leading-[1.8em] tracking-[0.03em]">
                  <p>
                    En <strong className="text-luxury-white font-medium">Luxury VIP Protection</strong> ofrecemos servicios de movilidad privada de alta gama en México, orientados a traslados que requieren seguridad, discreción y confiabilidad.
                  </p>

                  <p>
                    Contamos con una amplia flotilla de vehículos de última generación, blindados y discretos, diseñados para brindar comodidad, protección y continuidad operativa en cada traslado. Nuestro servicio se basa en planeación logística, coordinación directa y atención personalizada, adaptándonos a las necesidades específicas de cada agenda.
                  </p>

                  <p>
                    Nuestro equipo de operadores profesionales y personal de coordinación trabaja bajo protocolos claros de seguridad y confidencialidad, asegurando una experiencia eficiente, puntual y discreta en cada servicio.
                  </p>

                  <div className="bg-[#0B0B0B]/80 border-l-[3px] border-luxury-gold p-6 rounded-r-lg my-6 shadow-md relative overflow-hidden group/exp">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-luxury-gold/5 blur-2xl rounded-full pointer-events-none transition-all duration-500 group-hover/exp:bg-luxury-gold/10"></div>
                    <p className="relative z-10 text-[15px] md:text-[17px] text-luxury-white leading-relaxed">
                      Con más de <span className="text-2xl md:text-3xl font-display font-bold text-luxury-gold block mt-2 mb-2 drop-shadow-[0_0_8px_rgba(204,167,80,0.4)]">25 años de experiencia</span> en la renta de vehículos blindados, hemos participado en la logística de algunos de los eventos más relevantes en la República Mexicana, acompañando traslados ejecutivos, visitas institucionales y operaciones de alto nivel.
                    </p>
                  </div>

                  <p className="italic border-l border-luxury-gray/30 pl-5 py-2 text-[15px] md:text-[16px] bg-luxury-gold/5 rounded-r-md">
                    En Luxury VIP Protection entendemos que, cuando la coordinación exige discreción y precisión, el traslado debe ser confiable, seguro y perfectamente coordinado.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div>
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-px bg-luxury-gold"></div>
                <span className="text-[10px] text-luxury-gold uppercase tracking-[0.3em] font-semibold">LO QUE OFRECEMOS</span>
              </div>
              <h2 className="text-4xl md:text-[3.5rem] md:leading-tight font-display font-light">
                SERVICIOS <span className="font-bold text-luxury-gold drop-shadow-[0_0_10px_rgba(204,167,80,0.3)]">EXCLUSIVOS</span>
              </h2>
            </div>
            <p className="text-[16px] md:text-[18px] text-luxury-gray max-w-md lg:max-w-xl lg:mr-10 xl:mr-20 tracking-[0.1em] font-light leading-relaxed">
              Soluciones estructuradas para ejecutivos, diplomáticos y personalidades que requieren control operativo y logística impecable.
            </p>
          </div>

          <div className="flex flex-wrap justify-center items-stretch gap-6">
            {[
              { title: "RENTA DE VEHÍCULOS CON O SIN CHOFER", desc: "Ponemos a tu disposición una flotilla de camionetas blindadas y no blindadas, certificadas bajo estrictas normas de seguridad. Elige la modalidad con o sin chofer según tus necesidades.", image: "/service1.png" },
              { title: "ATENCIÓN A EMPRESAS Y CLIENTES PARTICULARES", desc: "Brindamos soluciones tanto a corporativos que requieren seguridad constante como a clientes individuales que buscan protección ocasional o para eventos especiales.", image: "/service2.png" },
              { title: "CHOFERES PROFESIONALES", desc: "Nuestros conductores están altamente capacitados en manejo defensivo, protocolos de seguridad y atención VIP, garantizando puntualidad, discreción y profesionalismo en cada trayecto.", image: "/service3.png" },
              { title: "MOVILIDAD POR DÍA, SEMANA O MES", desc: "Ofrecemos esquemas flexibles de movilidad privada por día, semana o mes, ideales para agendas ejecutivas, eventos especiales, visitas institucionales o estancias prolongadas, con coordinación directa, atención personalizada y asistencia operativa 24/7 durante todo el servicio.", image: "/service4.png" },
              { title: "EXPERIENCIA PERSONALIZADA A BORDO", desc: "Coordinamos experiencias personalizadas durante el traslado, con opciones de catering ejecutivo o premium, bebidas selectas y amenidades de confort, disponibles bajo solicitud previa y planeación anticipada.", image: "/experiencia-personalizada.jpg" }
            ].map((srv, idx) => (
              <div key={idx} className="w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] group border border-luxury-gray/20 bg-luxury-charcoal/40 hover:bg-black hover:border-luxury-gold/50 transition-all duration-500 rounded-sm flex flex-col relative overflow-hidden backdrop-blur-sm shadow-md">
                ...
                <div className="p-8 flex flex-col flex-1 relative z-10">
                  ...
                  <div className="mt-8">
                    <a
                      href={`https://wa.me/526623538274?text=${encodeURIComponent('Hola! Quiero saber más sobre: ' + srv.title)}`}
                      target="_blank"
                    ...
                    >
                      Saber Más <span className="text-sm">→</span>
                    </a>
                  </div>
                </div>
        ...
        <section id="flota" className="py-24 border-t border-luxury-gray/10 relative">
          <div className="flex flex-col items-center text-center mb-16">
            <div className="flex items-center justify-center gap-4 mb-4">
              ...
              <span className="text-[10px] text-luxury-gold uppercase tracking-[0.3em] font-semibold">CATÁLOGO EXCLUSIVO</span>
              <div className="w-8 h-px bg-luxury-gold"></div>
            </div>
        ...
        <section id="cobertura" className="py-24 border-t border-luxury-gray/10 relative">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            <div className="w-full lg:w-5/12 relative z-10 space-y-6">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-px bg-luxury-gold"></div>
                <span className="text-[10px] text-luxury-gold uppercase tracking-[0.3em] font-semibold">PRESENCIA NACIONAL</span>
              </div>

              <h2 className="text-4xl md:text-[3.5rem] md:leading-tight font-display font-light mb-8 uppercase">
                COBERTURA <span className="font-bold text-luxury-gold drop-shadow-[0_0_10px_rgba(204,167,80,0.3)]">GEOGRÁFICA</span>
              </h2>
              ...
              <div className="bg-[#0B0B0B] border border-[#D4AF37]/20 border-l-[3px] border-l-[#D4AF37] p-6 lg:p-7 rounded-sm shadow-[0_10px_30px_rgba(0,0,0,0.6)] backdrop-blur-sm mt-4">
                <p className="text-[17px] md:text-[18px] text-white tracking-[0.05em] font-light leading-relaxed">
                  Movemos unidades a cualquier ciudad según su itinerario; logística segura y puntualidad ejecutiva.
                </p>
              </div>
            </div>
            ...
            <div className="w-full lg:w-7/12 relative flex justify-center lg:justify-end z-10 transition-all duration-1000 ease-out">
              ...
              <div className="relative w-full aspect-square md:aspect-[16/9] lg:aspect-auto lg:h-[950px] max-w-none drop-shadow-[0_15px_40px_rgba(212,175,55,0.08)] lg:translate-x-12 lg:scale-[1.25] hover:lg:scale-[1.3] origin-right">
                <Image
                  ...
                  alt="Mapa de Cobertura Geográfica en México"
                  fill
        ...
        <section id="transparencia" className="py-24 border-t border-luxury-gray/10 relative">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            <div className="w-full lg:w-5/12 relative z-10 space-y-8">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-px bg-luxury-gold"></div>
                <span className="text-[10px] text-luxury-gold uppercase tracking-[0.3em] font-semibold">SEGURIDAD Y RESPALDO</span>
              </div>

              <h2 className="text-4xl md:text-[3.5rem] md:leading-tight font-display font-light mb-8 uppercase">
                TRANSPARENCIA Y <span className="font-bold text-luxury-gold drop-shadow-[0_0_10px_rgba(204,167,80,0.3)]">CONFIANZA</span>
              </h2>
              ...
              <div className="border border-luxury-gold/30 bg-[#1a1a1a]/40 p-6 md:p-8 rounded-sm shadow-[0_5px_25px_rgba(204,167,80,0.05)] backdrop-blur-sm relative overflow-hidden group">
                ...
                <p className="text-[17px] md:text-[19px] text-luxury-white tracking-[0.05em] font-light leading-relaxed italic border-l-2 border-luxury-gold/70 pl-5">
                  "Referencias disponibles bajo solicitud para mantener la privacidad de nuestros clientes."
                </p>
              </div>

              <div className="space-y-6 text-[16px] md:text-[18px] text-luxury-gray font-light leading-[1.8em] tracking-[0.05em]">
                <p>
                  En caso de contratar el servicio con operador, se comparte previamente la identificación del chofer asignado y se habilita contacto directo 24/7 para coordinación y seguimiento.
                </p>
                <p>
                  La operación se respalda con contratos claros y políticas internas que garantizan confidencialidad, profesionalismo y correcta ejecución en cada servicio.
                </p>
              </div>
            </div>
            ...
            <div className="w-full lg:w-7/12 relative flex justify-center lg:justify-end z-10 transition-all duration-1000 ease-out">
              ...
              <div className="relative w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[4/3] max-w-none border border-luxury-gray/20 rounded-sm overflow-hidden shadow-[0_15px_50px_rgba(0,0,0,0.8)] group">
                <Image
                  ...
                  alt="Chófer profesional abriendo la puerta de SUV de lujo"
                  fill
        ...
        <section id="contacto" className="py-24 border-t border-luxury-gray/10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 p-8 md:p-16 border border-luxury-gray/20 bg-luxury-charcoal/30 rounded-sm backdrop-blur-md relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-px bg-luxury-gold"></div>
                <span className="text-[10px] text-luxury-gold uppercase tracking-[0.3em] font-semibold">CONTACTO</span>
              </div>
              <h2 className="text-4xl md:text-[2.75rem] md:leading-tight font-display font-light mb-6">
                SOLICITE UNA <br />
                <span className="font-bold text-luxury-gold">VALORACIÓN PRIVADA</span>
              </h2>
              <p className="text-[16px] md:text-[18px] tracking-[0.1em] text-luxury-gray font-light leading-[2em] max-w-sm mb-12">
                Póngase en contacto con nuestro equipo para coordinar su logística. Respondemos con máxima celeridad.
              </p>
            ...
            <div className="relative z-10 w-full max-w-[720px] self-center rounded-sm border border-luxury-gray/10 bg-[#1F1F1F] p-5 shadow-lg sm:p-6 md:p-8 lg:max-w-[95%] lg:justify-self-end lg:p-10">
              ...
              <div className="mt-4 space-y-4">
                <p className="text-[14px] font-light leading-[1.75] tracking-[0.02em] text-luxury-gray sm:text-[15px] md:text-[16px] lg:text-[17px]">
                  Cada solicitud es tratada bajo estrictos protocolos de discreción y seguridad estratégica.
                </p>

                <p className="text-[14px] font-light leading-[1.75] tracking-[0.02em] text-luxury-gray sm:text-[15px] md:text-[16px] lg:text-[17px]">
                  Nuestro equipo coordina cada traslado con precisión ejecutiva y absoluta confidencialidad.
                </p>
              </div>
            </div>
        ...
        <footer className="py-12 mt-12 border-t border-luxury-gray/10 text-center flex flex-col items-center justify-center gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            <a
              href="https://wa.me/526623538274?text=Hola,%20me%20interesa%20informaci%C3%B3n%20sobre%20sus%20servicios."
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-luxury-gold text-[11px] tracking-[0.15em] hover:text-luxury-white transition-colors font-bold uppercase"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.888-.788-1.489-1.761-1.663-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.82 9.82 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z" />
              </svg>
          ...
          <p className="text-[13px] md:text-[14px] tracking-[0.2em] text-luxury-gray/60 uppercase mt-4">
            © {new Date().getFullYear()} Luxury VIP Protection. Todos los derechos reservados.
          </p>
        </footer>
